...
\newenvironment{Class}[1]{
      \begin{tcolorbox}[title=#1,colbacktitle=mintgreen,colframe=mintgreen,colbacktitle=mintgreen]
  }{
      \end{tcolorbox}
  }
...
\include{./chapters/Architektur}
\include{./chapters/Klassenbeschreibung}
