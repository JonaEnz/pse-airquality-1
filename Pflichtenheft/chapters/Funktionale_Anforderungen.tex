...
\subsection{Detailansicht}
 ...
 \item[Dynamische Anpassung nach Sensor]
   Da die \glspl{Station} verscheidene \glspl{Feature} bereitstellen können passt sich die Detailansicht entsprechend an.
 ...
 \item[Heute im Vergleich zum letzten Jahr]
   Ein \gls{Kuchendiagramm} das die Anzahl der Tage im letzten Jahr visualisiert an denen die \glspl{Messwert} gerimgfügig/sehr höher/niedriger waren als heute.
