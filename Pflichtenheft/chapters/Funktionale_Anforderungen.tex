...
\subsection{Allgemeine Anforderungen}
 ...
 \item[Statische Webanwendung]
   Die \gls{Webanwendung} erfordert den Server nur um die Anwendung zu übertragen.
   Sonst müssen keine Anfragen an den Server gestellt werden. 
...
\subsection{Detailansicht}
 ...
 \item[Dynamische Anpassung nach Sensor]
   ...
   Welche \glspl{Graph} für einen \gls{Messwert} angezeigt werden ist für jeden \gls{Messwert} festgelegt.
