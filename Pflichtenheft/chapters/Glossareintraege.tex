...
\newglossaryentry{Durchschnittsdiagramm}{
	name=Durchschnittsdiagramm,
	description={Das Diagramm -meistens \gls{Graph} - modelliert den ausgerechneten Durchscnitt der \glspl{Messwert}.}
}
