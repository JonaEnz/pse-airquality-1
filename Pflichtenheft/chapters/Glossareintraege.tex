...
\newglossaryentry{Feature}{
	name=Feature,
	description={Eine bestimmte Eigenschaft der Umgebung die von einer Messstation gemessen wird (z.B. Temperatur, Luftdruck, Luftfeuchtigkeit, ...)}
}

\newglossaryentry{Feinstaubindex}{
	name=Feinstaubindex,
	description={Der normierte schlechteste Wert der Feinstaubgrößen}
}
...
\newglossaryentry{Live-Karte}{
	name=Live-Karte,
	plural=Live-Karten,
	description={Eine interaktive Karte, die aktuelle \glspl{Messwert} anzeigt. Der Nutzer kann die Karte durch Ziehen mit der 
	Maus seitlich bewegen, sowie Einzoomen und Auszoomen}
}
