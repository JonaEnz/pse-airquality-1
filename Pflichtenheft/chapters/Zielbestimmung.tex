...
\begin{Kriterien}{MK}
	...
	\item Der Nutzer kann die Skala der Färbung und eine kurze Erklärung des gewählten Features anzeigen lassen.
...
\begin{Kriterien}{MK}
	\item Für die wichtigsten \glspl{Feature} wird ein Diagramm angezeigt, das die Entwicklung der \glspl{Messwert} zeigt. Die Zeitspanne ist einstellbar. Es werden nur Diagramme von Messwerten angezeigt, die an der \gls{Station} gemessen werden.
