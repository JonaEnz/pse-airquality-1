...
\begin{Kriterien}{MK}
	\item Eine i\gls{Live-Karte} zeigt alle \glspl{Station} gleichzeitig. 
...
\begin{Kriterien}{MK}	
	\item Es ist ein einem Klick möglich, von der \gls{Detailansicht} zur gls{Kartenansicht} zurückzukehren.
\end{Kriterien}
