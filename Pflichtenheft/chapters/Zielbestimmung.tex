...
\begin{Kriterien}{MK}
	...
	\item Die Antworten des \gls{FROST-Server} können die benötigten Daten für die \glspl{Graph} ausgelesen werden.
...
\begin{itemize}
    ...
    \item \gls{Kuchendiagramm}: Anzahl der Tage in Zeitraum an denen der Feinstaubwert höher war als heute.
\end{itemize}
