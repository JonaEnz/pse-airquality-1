...
\subsubsection{FeutureSelect-Button}
\paragraph{Symptom}
...
\subsubsection{Skala}
\paragraph{Symptom}
Größter Wert der Skala ist unrealistisch groß und damit ist die ganze Skala nutzlus.
...
\paragraph{Lösung}
Entsprechende Station aus der Query löschen.
